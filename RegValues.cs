...
namespace OneAssistanceSrvc
{
	...
	public class RegValues
	{
		...
		public void getRegValues()
		{
			...
			{
                setRegValue(mRegKey, "SystemDSN", "OneAssistance");
                m_DBInstance = "OneAssistance";
			}
			else
		...
		{
            RegistryKey mRegKey = Registry.LocalMachine.CreateSubKey("SOFTWARE\\OneAssistance");
            mRegKey.DeleteSubKey("Monitor");
			mRegKey.Close();
		}
		...
		public bool checkKey()
		{
			bool result = true;
            RegistryKey mRegKey = Registry.LocalMachine.CreateSubKey("SOFTWARE\\OneAssistance");
            if (mRegKey.OpenSubKey("Monitor") == null)
			{
				result = false;
			}
			mRegKey.Close();
